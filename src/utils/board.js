...
export const board = [
    [
        { field: 111, piece: { name: "rook", color: "white", steps: 0 } }, 
        { field: 122, piece: { name: "knight", color: "white", steps: 0 } }, 
        { field: 131, piece: { name: "bishop", color: "white", steps: 0 } }, 
        { field: 142, piece: { name: "queen", color: "white", steps: 0 } }, 
        { field: 151, piece: { name: "king", color: "white", steps: 0 } }, 
        { field: 162, piece: { name: "bishop", color: "white", steps: 0 } }, 
        { field: 171, piece: { name: "knight", color: "white", steps: 0 } }, 
        { field: 182, piece: { name: "rook", color: "white", steps: 0 } }
    ],
    [
        { field: 212, piece: { name: "pawn", color: "white", steps: 0 } }, 
        { field: 221, piece: { name: "pawn", color: "white", steps: 0 } }, 
        { field: 232, piece: { name: "pawn", color: "white", steps: 0 } }, 
        { field: 241, piece: { name: "pawn", color: "white", steps: 0 } }, 
        { field: 252, piece: { name: "pawn", color: "white", steps: 0 } }, 
        { field: 261, piece: { name: "pawn", color: "white", steps: 0 } }, 
        { field: 272, piece: { name: "pawn", color: "white", steps: 0 } }, 
        { field: 281, piece: { name: "pawn", color: "white", steps: 0 } }
    ],
    [
    ...
    [
        { field: 711, piece: { name: "pawn", color: "black", steps: 0 } }, 
        { field: 722, piece: { name: "pawn", color: "black", steps: 0 } },
        { field: 731, piece: { name: "pawn", color: "black", steps: 0 } }, 
        { field: 742, piece: { name: "pawn", color: "black", steps: 0 } }, 
        { field: 751, piece: { name: "pawn", color: "black", steps: 0 } }, 
        { field: 762, piece: { name: "pawn", color: "black", steps: 0 } }, 
        { field: 771, piece: { name: "pawn", color: "black", steps: 0 } }, 
        { field: 782, piece: { name: "pawn", color: "black", steps: 0 } }
    ],
    [
        { field: 812, piece: { name: "rook", color: "black", steps: 0 } }, 
        { field: 821, piece: { name: "knight", color: "black", steps: 0 } }, 
        { field: 832, piece: { name: "bishop", color: "black", steps: 0 } }, 
        { field: 841, piece: { name: "queen", color: "black", steps: 0 } }, 
        { field: 852, piece: { name: "king", color: "black", steps: 0 } }, 
        { field: 861, piece: { name: "bishop", color: "black", steps: 0 } }, 
        { field: 872, piece: { name: "knight", color: "black", steps: 0 } }, 
        { field: 881, piece: { name: "rook", color: "black", steps: 0 } }
    ]
];     
